...
const Home = ({ setCurrentView, setStudentId }) => {
  ...
  return (
      <div className="admin-panel">
        ...
        <div className="search-bar">
          <input type="text" placeholder="Busca o pincha en un alumno para modificar o eliminar" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
